 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const S=new class{handleAttributeExpressions(e,t,s,n){const i=t[0];if("."===i){return new k(e,t.slice(1),s).parts}return"@"===i?[new V(e,t.slice(1),n.eventContext)]:"?"===i?[new y(e,t.slice(1),s)]:new x(e,t,s).parts}handleTextExpression(e){return new b(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const $=(e,...t)=>new g(e,t,"html",S);class R extends HTMLElement{connectedCallback(){this.render()}static get observedAttributes(){return["markdown"]}attributeChangedCallback(e,t,s){this.render()}render(){const e=this.getAttribute("markdown");if(!e)return void(this.innerHTML="");if(!/(\n-)|`/.test(e))return void(this.innerHTML=e);const t=this._escapeHtml(e);let s=this._convertMarkdownLists(t);s=this._convertMarkdownCodeBlocks(s),this.innerHTML=s}_convertMarkdownLists(e){let t=!1,s=[];for(const n of e.split(/\n/))t&&""===n?(t=!1,s.push("</ul>")):n.startsWith("-")?(t||s.push("<ul>"),t=!0,s.push("  <li>"+n.replace(/^- /,""))):s.push(n);return t&&s.push("</ul>"),s.join("\n")}_convertMarkdownCodeBlocks(e){const t=[],s=e.split(/`(.*?)`/g);for(;s.length;){const[e,n]=s.splice(0,2);t.push(e),n&&t.push(`<code>${n}</code>`)}return t.join("")}_escapeHtml(e){var t,s=""+e,n=/["'&<>]/.exec(s);if(!n)return s;var i="",o=0,r=0;for(o=n.index;o<s.length;o++){switch(s.charCodeAt(o)){case 34:t='"';break;case 38:t="&amp;";break;case 39:t="&#39;";break;case 60:t="&lt;";break;case 62:t="&gt;";break;default:continue}r!==o&&(i+=s.substring(r,o)),r=o+1,i+=t}return r!==o?i+s.substring(r,o):i}}customElements.define("cr-markdownish",R);class H{constructor(e){this.index=e,this.keys=Object.keys(e)}getMatches(e){if(!e)return[];let t,s=e.toLowerCase(),n=!1;if(this.prevKey_){0===s.indexOf(this.prevKey_)&&(n=!0)}if(n)t=this.prevMatches_.filter(e=>-1!==e.indexOf(s));else{const e=[],n=[];this.keys.forEach(t=>{let i=t.indexOf(s);0===i?e.push(t):-1!==i&&n.push(t)}),t=e.concat(n)}return this.prevKey_=s,this.prevMatches_=t,t.map(e=>this.index[e])}}const U={0:"Domain",1:"Event",2:"Parameter",3:"Type",4:"Method"};class P extends HTMLElement{constructor(e){super(),this.attachShadow({mode:"open"}),this.baseUrl=e}set searchString(e){this.matches=this.keywordsModel.getMatches(e),C($`
    ...
    `,this.shadowRoot,{eventContext:this})}handleArrows(e){switch(e.code){case"ArrowDown":return void this.menu.focusDown();case"ArrowUp":return void this.menu.focusUp();case"Enter":return e.preventDefault(),void this.menu.select()}"Escape"===e.code&&(this.inputElement.value="",this.inputElement.blur());const t=this.inputElement.value;""!==t?(this.menu.connected||this.menuContainer.replaceWith(this.menu),this.menu.searchString=t):this.menu.replaceWith(this.menuContainer)}});const F=document.querySelector(".menu-link"),I=document.querySelector("aside"),B=document.querySelector("main"),O=document.querySelector(".aside-close-button");function W(){if(!I.classList.contains("shown"))return!1;I.classList.remove("shown"),F.focus()}document.addEventListener("keydown",e=>{e.metaKey||(e.keyCode>=65&&e.keyCode<=90&&document.querySelector("cr-search-control").inputElement.focus(),"Escape"===e.key&&I.classList.contains("shown")&&I.classList.remove("shown"))}),F.addEventListener("click",e=>{e.stopPropagation(),I.addEventListener("transitionend",()=>{O.focus()},{once:!0}),I.classList.add("shown")}),B.addEventListener("click",W),O.addEventListener("click",W);
