 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const v=` ${r} `;class g{constructor(e,t,s,n){this.strings=e,this.values=t,this.type=s,this.processor=n}getHTML(){const e=this.strings.length-1;let t="",s=!1;for(let n=0;n<e;n++){const e=this.strings[n],i=e.lastIndexOf("\x3c!--");s=(i>-1||s)&&-1===e.indexOf("--\x3e",i+1);const o=p.exec(e);t+=null===o?e+(s?v:a):e.substr(0,o.index)+o[1]+o[2]+"$lit$"+o[3]+r}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const M=new class{handleAttributeExpressions(e,t,s,n){const i=t[0];if("."===i){return new N(e,t.slice(1),s).parts}return"@"===i?[new V(e,t.slice(1),n.eventContext)]:"?"===i?[new y(e,t.slice(1),s)]:new x(e,t,s).parts}handleTextExpression(e){return new b(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function T(e){let t=S.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},S.set(e.type,t));let s=t.stringsArray.get(e.strings);if(void 0!==s)return s;const n=e.strings.join(r);return s=t.keyString.get(n),void 0===s&&(s=new c(e,e.getTemplateElement()),t.keyString.set(n,s)),t.stringsArray.set(e.strings,s),s}const S=new Map,C=new WeakMap,L=(e,t,s)=>{let i=C.get(t);void 0===i&&(n(t,t.firstChild),C.set(t,i=new b(Object.assign({templateFactory:T},s))),i.appendInto(t)),i.setValue(e),i.commit()};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const $=(e,...t)=>new g(e,t,"html",M);class R extends HTMLElement{connectedCallback(){this.render()}static get observedAttributes(){return["markdown"]}attributeChangedCallback(e,t,s){this.render()}render(){const e=this.getAttribute("markdown");if(!e)return void(this.innerHTML="");if(!/(\n-)|`/.test(e))return void(this.innerHTML=e);const t=this._escapeHtml(e);let s=this._convertMarkdownLists(t);s=this._convertMarkdownCodeBlocks(s),this.innerHTML=s}_convertMarkdownLists(e){let t=!1,s=[];for(const n of e.split(/\n/))t&&""===n?(t=!1,s.push("</ul>")):n.startsWith("-")?(t||s.push("<ul>"),t=!0,s.push("  <li>"+n.replace(/^- /,""))):s.push(n);return t&&s.push("</ul>"),s.join("\n")}_convertMarkdownCodeBlocks(e){const t=[],s=e.split(/`(.*?)`/g);for(;s.length;){const[e,n]=s.splice(0,2);t.push(e),n&&t.push(`<code>${n}</code>`)}return t.join("")}_escapeHtml(e){var t,s=""+e,n=/["'&<>]/.exec(s);if(!n)return s;var i="",o=0,r=0;for(o=n.index;o<s.length;o++){switch(s.charCodeAt(o)){case 34:t='"';break;case 38:t="&amp;";break;case 39:t="&#39;";break;case 60:t="&lt;";break;case 62:t="&gt;";break;default:continue}r!==o&&(i+=s.substring(r,o)),r=o+1,i+=t}return r!==o?i+s.substring(r,o):i}}customElements.define("cr-markdownish",R);class H{constructor(e){this.index=e,this.keys=Object.keys(e)}getMatches(e){if(!e)return[];let t,s=e.toLowerCase(),n=!1;if(this.prevKey_){0===s.indexOf(this.prevKey_)&&(n=!0)}if(n)t=this.prevMatches_.filter(e=>-1!==e.indexOf(s));else{const e=[],n=[];this.keys.forEach(t=>{let i=t.indexOf(s);0===i?e.push(t):-1!==i&&n.push(t)}),t=e.concat(n)}return this.prevKey_=s,this.prevMatches_=t,t.map(e=>this.index[e])}}const U={0:"Domain",1:"Event",2:"Parameter",3:"Type",4:"Method"};class F extends HTMLElement{constructor(e){super(),this.attachShadow({mode:"open"}),this.baseUrl=e}set searchString(e){this.matches=this.keywordsModel.getMatches(e),L($`
    ...
    `,this.shadowRoot,{eventContext:this})}handleArrows(e){switch(e.code){case"ArrowDown":return void this.menu.focusDown();case"ArrowUp":return void this.menu.focusUp();case"Enter":return e.preventDefault(),void this.menu.select()}"Escape"===e.code&&(this.inputElement.value="",this.inputElement.blur());const t=this.inputElement.value;""!==t?(this.menu.connected||this.menuContainer.replaceWith(this.menu),this.menu.searchString=t):this.menu.replaceWith(this.menuContainer)}}),document.addEventListener("keydown",e=>{e.metaKey||e.keyCode>=65&&e.keyCode<=90&&document.querySelector("cr-search-control").inputElement.focus()});
